...
syn keyword actionScriptRepeat				do while for in with
syn keyword actionScriptStatement			break continue delete return
...
syn keyword actionScriptAS2 				class extends public private static interface implements import dynamic intrinsic
...
syn keyword flash8Constant  				ALPHANUMERIC_FULL ALPHANUMERIC_HALF CHINESE JAPANESE_HIRAGANA JAPANESE_KATAKANA_FULL JAPANESE_KATAKANA_HALF KOREAN UNKNOWN
...
" The following are deprecated in AS 1.0 and above
syn keyword actionScriptDeprecatedGlobals		add le lt gt ge eq ne chr mbchr mblength mbord mbsubstring ord
syn keyword actionScriptDeprecatedConstant		newline
syn keyword actionScriptDeprecatedOperator		and or not
...
if version >= 508 || !exists("did_actionscript_syn_inits")
  ...
  HiLink flash8Constant			Constant
  HiLink flash8Functions		Function
  HiLink flash8Properties		Type
  HiLink flash8Classes 			Type
  HiLink actionScriptInclude		Include
  " Highlight deprecated global functions as errors
  HiLink actionScriptDeprecatedGlobals	Error
  HiLink actionScriptDeprecatedConstant	Error
  HiLink actionScriptDeprecatedOperator	Error
  delcommand HiLink
endif
